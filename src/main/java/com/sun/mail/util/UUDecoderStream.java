...
public class UUDecoderStream extends FilterInputStream {
        ...
        for (;;) {
            ...
            if (s.regionMatches(true, 0, "begin", 0, 5)) {
                try {
                    ...
                    throw new IOException("UUDecoder error: "
                            + ex.toString());
                }
                name = s.substring(10);
                gotPrefix = true;
    ...
    private boolean decode() throws IOException {
        ...
        if (count == 0) {
            line = lin.readLine();
            if (line == null
                    || !line.regionMatches(true, 0, "end", 0, 3))
                throw new IOException("Missing End");
            gotEnd = true;
            return false;
        }
    ...
    {
    	FileInputStream infile = new FileInputStream("C:/Users/mfb/Downloads/usenet/car/uu.txt");
