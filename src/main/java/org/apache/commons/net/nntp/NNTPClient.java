...
public class NNTPClient extends NNTP
{
        ...
        throws IOException
    {
        ...
        // block added by MFB (for HelloNzb application)
        // the last line of the block (return false) is
        // from original source
        if(replyCode == NNTPReply.AUTHENTICATION_ACCEPTED)	// added by MFB
        	return true;									// added by MFB
        else												// added by MFB
        	return false;
    }
