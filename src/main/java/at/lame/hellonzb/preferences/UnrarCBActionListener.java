...
/**
 * This class handles the Unrar checkbox action on the preferences dialog.
 */
public class UnrarCBActionListener implements ActionListener
{
	/** main preferences object */
	private HelloNzbPreferences prefMain;
	
	
	public UnrarCBActionListener(HelloNzbPreferences pref)
	{
		this.prefMain = pref;
	}
